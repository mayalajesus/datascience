...
with tabs[0]:
    ...
    with colge2:
        ...
        geral_fem["Faixa Populacional"] = geral_fem["Pop"].apply(
            atribuir_faixa_populacional
        )
        contagem_faixa_populacional = (
            geral_fem["Faixa Populacional"].value_counts().reset_index()
        )
        contagem_faixa_populacional.columns = ["Faixa Populacional", "Contagem"]

        # Calcula a frequência relativa
        contagem_faixa_populacional["Frequencia_Relativa"] = (
            contagem_faixa_populacional["Contagem"]
            / contagem_faixa_populacional["Contagem"].sum()
        )
    ...
    for i, faixa in enumerate(faixas_etarias):
        ...
        filtered_data = geral_fem[
            (geral_fem["Idade"] >= min_age) & (geral_fem["Idade"] <= max_age)
        ]
        ...
        fig = ff.create_distplot(
            [filtered_data["Idade"]], [faixa_label], bin_size=5, show_curve=True
        )
...
with tabs[1]:
    ...
    with colpre1:
        ...
        escolaridade_pre_fem = (
            pre_fem.groupby("Escolaridade")["Escolaridade"]
            .count()
            .reset_index(name="Frequência acumulada")
        )
        escolaridade_pre_fem["Percentagem"] = freq_rel(
            escolaridade_pre_fem["Frequência acumulada"]
        )
        escolaridade_pre_fem = (
            escolaridade_pre_fem.reset_index()
            .drop("index", axis=1)
            .sort_values(by="Percentagem", ascending=False)
        )
        escolaridade_pre_fem["Percentagem"] = escolaridade_pre_fem["Percentagem"].apply(
            lambda x: f"{x:.2f}%"
        )
    ...
    with colpre2:
        ...
        rg_pre = (
            pre_fem.groupby("Regiao")["Regiao"].count().reset_index(name="Contagem")
        )
        rg_pre["Percentagem"] = freq_rel(rg_pre["Contagem"]).apply(
            lambda x: f"{x:.2f}%"
        )
        rg_pre = (
            rg_pre.reset_index()
        ...
        contagem_autodeclara_sim_pre = (
            autodeclara_sim_pre["Raça"].value_counts().reset_index()
        )
        ...
        figbar2.update_traces(
            text=contagem_raca_paleta_pre["Contagem"],
            textposition="outside",
            showlegend=False,
        )
        ...
        figbar3.update_traces(
            text=contagem_autodeclara_sim_pre["Contagem"],
            textposition="outside",
            showlegend=False,
        )
...
with tabs[2]:
    ...
    with coledu1:
        ...
        escolaridade_edu_fem = (
            edu_fem.groupby("Escolaridade")["Escolaridade"]
            .count()
            .reset_index(name="Frequência acumulada")
        )
        escolaridade_edu_fem["Percentagem"] = freq_rel(
            escolaridade_edu_fem["Frequência acumulada"]
        )
        escolaridade_edu_fem = (
            escolaridade_edu_fem.reset_index()
            .drop("index", axis=1)
            .sort_values(by="Percentagem", ascending=False)
        )
        escolaridade_edu_fem["Percentagem"] = escolaridade_edu_fem["Percentagem"].apply(
            lambda x: f"{x:.2f}%"
        )
    ...
    with coledu2:
        ...
        # Agrupando por região
        rg_edu = (
            edu_fem.groupby("Regiao")["Regiao"].count().reset_index(name="Contagem")
        )
        rg_edu["Percentagem"] = freq_rel(rg_edu["Contagem"]).apply(
            lambda x: f"{x:.2f}%"
        )
        rg_edu = (
            rg_edu.reset_index()
        ...
        contagem_autodeclara_sim_edu = (
            autodeclara_sim_edu["Raça"].value_counts().reset_index()
        )
        ...
        figbar2.update_traces(
            text=contagem_raca_paleta_edu["Contagem"],
            textposition="outside",
            showlegend=False,
        )
        ...
        figbar3.update_traces(
            text=contagem_autodeclara_sim_edu["Contagem"],
            textposition="outside",
            showlegend=False,
        )
...
with tabs[3]:
    ...
    with colcul1:
        ...
        escolaridade_cul_fem = (
            cul_fem.groupby("Escolaridade")["Escolaridade"]
            .count()
            .reset_index(name="Frequência acumulada")
        )
        escolaridade_cul_fem["Percentagem"] = freq_rel(
            escolaridade_cul_fem["Frequência acumulada"]
        )
        escolaridade_cul_fem = (
            escolaridade_cul_fem.reset_index()
            .drop("index", axis=1)
            .sort_values(by="Percentagem", ascending=False)
        )
        escolaridade_cul_fem["Percentagem"] = escolaridade_cul_fem["Percentagem"].apply(
            lambda x: f"{x:.2f}%"
        )
    ...
    with colcul2:
        ...
        # Agrupando por região
        rg_cul = (
            cul_fem.groupby("Regiao")["Regiao"].count().reset_index(name="Contagem")
        )
        rg_cul["Percentagem"] = freq_rel(rg_cul["Contagem"]).apply(
            lambda x: f"{x:.2f}%"
        )
        rg_cul = (
            rg_cul.reset_index()
        ...
        contagem_autodeclara_sim_cul = (
            autodeclara_sim_cul["Raça"].value_counts().reset_index()
        )
        ...
        figbar2.update_traces(
            text=contagem_raca_paleta_cul["Contagem"],
            textposition="outside",
            showlegend=False,
        )
        ...
        figbar3.update_traces(
            text=contagem_autodeclara_sim_cul["Contagem"],
            textposition="outside",
            showlegend=False,
        )
...
with tabs[4]:
    ...
    with colesp1:
        ...
        escolaridade_esp_fem = (
            esp_fem.groupby("Escolaridade")["Escolaridade"]
            .count()
            .reset_index(name="Frequência acumulada")
        )
        escolaridade_esp_fem["Percentagem"] = freq_rel(
            escolaridade_esp_fem["Frequência acumulada"]
        )
        escolaridade_esp_fem = (
            escolaridade_esp_fem.reset_index()
            .drop("index", axis=1)
            .sort_values(by="Percentagem", ascending=False)
        )
        escolaridade_esp_fem["Percentagem"] = escolaridade_esp_fem["Percentagem"].apply(
            lambda x: f"{x:.2f}%"
        )
    ...
    with colesp2:
        ...
        # Agrupando por região
        rg_esp = (
            esp_fem.groupby("Regiao")["Regiao"].count().reset_index(name="Contagem")
        )
        rg_esp["Percentagem"] = freq_rel(rg_esp["Contagem"]).apply(
            lambda x: f"{x:.2f}%"
        )
        rg_esp = (
            rg_esp.reset_index()
        ...
        contagem_autodeclara_sim_esp = (
            autodeclara_sim_esp["Raça"].value_counts().reset_index()
        )
        ...
        figbar2.update_traces(
            text=contagem_raca_paleta_esp["Contagem"],
            textposition="outside",
            showlegend=False,
        )
        ...
        figbar3.update_traces(
            text=contagem_autodeclara_sim_esp["Contagem"],
            textposition="outside",
            showlegend=False,
        )
...
with tabs[5]:
    ...
    with colsau1:
        ...
        escolaridade_sau_fem = (
            sau_fem.groupby("Escolaridade")["Escolaridade"]
            .count()
            .reset_index(name="Frequência acumulada")
        )
        escolaridade_sau_fem["Percentagem"] = freq_rel(
            escolaridade_sau_fem["Frequência acumulada"]
        )
        escolaridade_sau_fem = (
            escolaridade_sau_fem.reset_index()
            .drop("index", axis=1)
            .sort_values(by="Percentagem", ascending=False)
        )
        escolaridade_sau_fem["Percentagem"] = escolaridade_sau_fem["Percentagem"].apply(
            lambda x: f"{x:.2f}%"
        )
    ...
    with colsau2:
        ...
        # Agrupando por região
        rg_sau = (
            sau_fem.groupby("Regiao")["Regiao"].count().reset_index(name="Contagem")
        )
        rg_sau["Percentagem"] = freq_rel(rg_sau["Contagem"]).apply(
            lambda x: f"{x:.2f}%"
        )
        rg_sau = (
            rg_sau.reset_index()
        ...
        contagem_autodeclara_sim_sau = (
            autodeclara_sim_sau["Raça"].value_counts().reset_index()
        )
        ...
        figbar2.update_traces(
            text=contagem_raca_paleta_sau["Contagem"],
            textposition="outside",
            showlegend=False,
        )
        ...
        figbar3.update_traces(
            text=contagem_autodeclara_sim_sau["Contagem"],
            textposition="outside",
            showlegend=False,
        )
